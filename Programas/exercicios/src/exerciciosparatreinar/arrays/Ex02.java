...
public class Ex02 {
    public static void main(String[] args) {
        ...
        System.out.println("Digitando o CPF");
        System.out.println("Os dígitos verificadores serão considerados 0 por enquanto");

        for (int i = 0; i < cpf.length; i++) {
            System.out.print((i + 1) + "° dígito do CPF: ");
            cpf[i] = scanner.nextInt();
        }
        System.out.println("CPF: " + cpf[0] + "" + cpf[1] + "" + cpf[2] + "." + cpf[3] + "" + cpf[4] + "" + cpf[5] + "." + cpf[6] + "" + cpf[7] + "" + cpf[8] + "-" + cpf[9] + "" + cpf[10]);
        ...
        System.out.println("Multiplicador: " + multiplicador[0] + " " + multiplicador[1] + " " + multiplicador[2] + " " + multiplicador[3] + " " + multiplicador[4] + " " + multiplicador[5] + " " + multiplicador[6] + " " + multiplicador[7] + " " + multiplicador[8] + " " + multiplicador[9] + " " + multiplicador[10]);
        ...
        System.out.println("Resultado multiplicação: " + resultado[0] + " " + resultado[1] + " " + resultado[2] + " " + resultado[3] + " " + resultado[4] + " " + resultado[5] + " " + resultado[6] + " " + resultado[7] + " " + resultado[8] + " " + resultado[9] + " " + resultado[10]);
        ...
        System.out.println("CPF com 1° dígito verificador: " + cpf[0] + "" + cpf[1] + "" + cpf[2] + "." + cpf[3] + "" + cpf[4] + "" + cpf[5] + "." + cpf[6] + "" + cpf[7] + "" + cpf[8] + "-" + cpf[9] + "" + cpf[10]);
